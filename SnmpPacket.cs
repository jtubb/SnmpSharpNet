...
namespace SnmpSharpNet
{
    ...
    public abstract class SnmpPacket
    {
        ...
        public bool IsReport
        {
            get
            {
                if (Pdu != null && Pdu.Type == PduType.Response)
                    return true;
                return false;
            }
        }
        ...
        public bool IsRequest
        {
            get
            {
                if (Pdu != null && (Pdu.Type == PduType.Get || Pdu.Type == PduType.GetNext ||
        ...
        public bool IsNotification
        {
            get
            {
                if (Pdu != null && (Pdu.Type == PduType.Trap || Pdu.Type == PduType.V2Trap || Pdu.Type == PduType.Inform))
                    return true;
                return false;
            }
        }
